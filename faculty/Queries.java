...
class Queries {
  ...
  // Get SJSU ID from internal ID
	public static String TowerIDQuery = "SELECT towerid FROM sjsu_people_users WHERE faculty_id=?";
  ...
  // Get official position(s) description for a faculty
	public static String JobsQuery = "SELECT position_descr, deptid_descr FROM sjsu_people_job_details_master WHERE towerid=?";
